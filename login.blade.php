            ...
            <div class="p-4">
                ...
                <form action="" method="POST">
                    <div class="form-group m-0">
                        <label class="mb-0" for=""><strong class="text-left small-font">Email or mobile phone number</strong></label>
                        <input type="text" class="form-control placeholder form-control-sm" placeholder="Email or Phone Number">
                    </div>

                    <div class="form-group m-0">
                        <label class="mb-0" for=""><strong class="text-left small-font">Password</strong></label>
                        <input type="text" class="form-control placeholder form-control-sm" placeholder="Password">
                    </div>

                    <div class="form-group mt-2">
                        <button class="btn btn-outline-danger btn-sm btn-block">Login</button>
                    </div>
    ...
    <div class="col d-flex justify-content-center">
        <div class="hr-text text-secondary text-center">
            <span style="font-size: 12px; background-color: #fff; padding: 0 10px;">
                Don't have an account? <!--Padding is optional-->
            </span>
        </div>
    </div>

    <div class="col mt-4 d-flex justify-content-center">
        <a style="width: 350px;" href="{{ url('/register') }}" class="btn simple-btn btn-sm">Sign Up Now</a>
    </div>
</body>